 ...
 * {@hide}
 */
public class X00IRIL extends RIL implements CommandsInterface {

    public X00IRIL(Context context, int preferredNetworkType, int cdmaSubscription) {
        this(context, preferredNetworkType, cdmaSubscription, null);
    }

    public X00IRIL(Context context, int preferredNetworkType,
